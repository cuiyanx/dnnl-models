...
describe('CTS', function() {
  ...
  it('check result for Conv2d v1_2 example-1', async function() {
    ...
    model.setOperandSymmPerChannelQuantParams(type35, {channelDim=0, scales=[0.125]});
  ...
  it('check result for Conv2d v1_2 example-3', async function() {
    ...
    model.setOperandSymmPerChannelQuantParams(type50, {channelDim=0, scales=[0.5]});
  ...
  it('check result for Conv2d v1_2 example-5', async function() {
    ...
    model.setOperandSymmPerChannelQuantParams(type60, {channelDim=0, scales=[0.5, 0.4, 0.3]});
  ...
  it('check result for Conv2d v1_2 example-7', async function() {
    ...
    model.setOperandSymmPerChannelQuantParams(type71, {channelDim=0, scales=[0.5, 1.0, 0.5]});
  ...
  it('check result for Conv2d v1_2 example-8', async function() {
    ...
    model.setOperandSymmPerChannelQuantParams(type74, {channelDim=0, scales=[0.5, 1.0, 1.005]});
    let op33 = operandIndex++;
